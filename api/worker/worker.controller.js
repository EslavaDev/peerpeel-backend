...
exports.register = (req, res) => {
  ...
  admin.auth().createUser({
    ...
    .then((auth) => {
      ...
      if (typeof idFront === 'string' && idFront !== null && idFront.length > 0) {
        params.idFront = idFront;
      }
      if (typeof idBack === 'string' && idBack !== null && idBack.length > 0) {
        params.idBack = idBack;
      }
      service.SavedDataBasePromise(params, 'workers', auth)
